...
column_mapping = {
    ...
    "instrument.name": { "name": "acq_instrument", "type": "[t]" },
    # "instrument.serialNumber": { "name": "acq_serialNumber", "type": "[t]" },
    "instrument.serialNumber": { "name": "acq_id", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.TabName": { "name": "sample_TabName", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.SamplePompSpeed": { "name": "object_SamplePompSpeed", "type": "[f]", "transform": None },
    "instrument.measurementSettings.CytoSettings.LimitParticleRate": { "name": "object_LimitParticleRate", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.TriggerLevel1e": { "name": "object_TriggerLevel1e", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.TriggerChannel": { "name": "sample_TriggerChannel", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.StopafterTimertext": { "name": "sample_StopafterTimertext", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.MaxNumberParticleText": { "name": "object__MaxNumberParticleText", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.StopAtParticles": { "name": "sample_StopAtParticles", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.StopAtParticlesString": { "name": "sample_StopAtParticlesString", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.MaxAnalysedVolume": { "name": "object_MaxAnalysedVolume", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.StopAtAnalysedVolume": { "name": "sample_StopAtAnalysedVolume", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.StopAtAnalysedVolumeString": { "name": "sample_StopAtAnalysedVolumeString", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.MaxPumpedVolume": { "name": "object_MaxPumpedVolume", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.StopAtPumpedVolume": { "name": "sample_StopAtPumpedVolume", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.StopAtPumpedVolumeString": { "name": "sample_StopAtPumpedVolumeString", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.MaxNumberFotoText": { "name": "object_MaxNumberFotoText", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.StopAtFotos": { "name": "sample_StopAtFotos", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.StopAtFotosString": { "name": "object_StopAtFotosString", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.StopAfterTime": { "name": "sample_StopAfterTime", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.FlushCheck": { "name": "sample_FlushCheck", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    ...
    "instrument.measurementSettings.CytoSettings.IIFuseTargetAll": { "name": "sample_IIFuseTargetAll", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.IIFuseTargetRange": { "name": "sample_IIFuseTargetRange", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.IIFuseSmartGrid": { "name": "sample_IIFuseSmartGrid", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.SmartGrid_str": { "name": "sample_SmartGrid_str", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.IifSmartGridChannelIds1": { "name": "sample_IifSmartGridChannelIds1", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.IifSmartGridChannelIds2": { "name": "sample_IifSmartGridChannelIds2", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.IIFRestrictFwsRange": { "name": "sample_IIFRestrictFwsRange", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.IIFFwsRatioMin": { "name": "object_IIFFwsRatioMin", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.IIFFwsRatioMax": { "name": "object_IIFFwsRatioMax", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.IIFPhotographLargeParticles": { "name": "sample_IIFPhotographLargeParticles", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.IIFUseSetDefintionSelector": { "name": "sample_IIFUseSetDefintionSelector", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.IIFSetDefintionFileName": { "name": "sample_IIFSetDefintionFileName", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.IIFSetSelectionInfo.WantImages": { "name": "object_WantImages", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.IIFSetSelectionInfo.NumberOfImages": { "name": "object_NumberOfImages", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.IIFRoiName": { "name": "sample_IIFRoiName", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.HasExternalTrigger": { "name": "sample_HasExternalTrigger", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.ExternalTriggerIsPulse": { "name": "sample_ExternalTriggerIsPulse", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.ExternalTriggerFeedbackLed": { "name": "object_ExternalTriggerFeedbackLed", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.triggerlevelConstant": { "name": "sample_triggerlevelConstant", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.triggerlevelOffset": { "name": "object_triggerlevelOffset", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.CytoUSBSettings.release.ReleaseDate": { "name": "acq_ReleaseDateDay", "type": "[t]", "transform": extract_date_utc },
    "instrument.measurementSettings.CytoSettings.CytoSettings.CytoUSBSettings.release.ReleaseDate*ReleaseDate": { "name": "acq_ReleaseDateHour", "type": "[t]", "transform": extract_time_utc },
    "instrument.measurementSettings.CytoSettings.CytoSettings.CytoUSBSettings.CytoUSBVersion": { "name": "acq_CytoUSBVersion", "type": "[t]", "transform": extract_commit_version },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Gain": { "name": "object_Gain", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Brightness": { "name": "object_Brightness", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.ROITop": { "name": "object_ROITop", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.ROILeft": { "name": "object_ROILeft", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.ROIWidth": { "name": "object_ROIWidth", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.ROIHeight": { "name": "object_ROIHeight", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.HorizontalFlip": { "name": "object_HorizontalFlip", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.VerticalFlip": { "name": "object_VerticalFlip", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Rotate": { "name": "object_Rotate", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Compression": { "name": "acq_Compression", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.TriggerPositive": { "name": "acq_TriggerPositive", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.CameraDelay": { "name": "object_CameraDelay", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.CameraDelayOffset_us": { "name": "object_CameraDelayOffset_us", "type": "[f]" },
    # "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Background.Data": { "name": "Data", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.ExposureTime": { "name": "object_ExposureTime", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.framerate": { "name": "object_framerate", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.CameraName": { "name": "acq_CameraName", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.Description": { "name": "acq_Description", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.FirmwareVersion": { "name": "acq_FirmwareVersion", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.FpgaVersion": { "name": "acq_FpgaVersion", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.LensDescription": { "name": "acq_LensDescription", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.ModelName": { "name": "acq_ModelName", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.SerialNumber": { "name": "acq_SerialNumber", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.Camera.VendorName": { "name": "acq_VendorName", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.dBGain": { "name": "object_dBGain", "type": "[f]", "transform": None },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.opticalMagnification": { "name": "object_opticalMagnification", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.FlashDurationCount": { "name": "object_FlashDurationCount", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.ImageScaleMuPerPixelP": { "name": "sample_ImageScaleMuPerPixelP", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.EnableOverrideMuPerPixel": { "name": "sample_EnableOverrideMuPerPixel", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.iif.AllwaysTakeLargerParticlePictures": { "name": "acq_AllwaysTakeLargerParticlePictures", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.EnableCompressIIFImages": { "name": "acq_EnableCompressIIFImages", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.EnableSaveUnmatchedIIFFoto": { "name": "acq_EnableSaveUnmatchedIIFFoto", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    ...
    "instrument.measurementSettings.CytoSettings.CytoSettings.Laser1Model": { "name": "acq_Laser1Model", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.SubLoopVolume_uL": { "name": "object_SubLoopVolume_uL", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.OpticalMagnification": { "name": "object_OpticalMagnification", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.ImagePixelSize": { "name": "acq_ImagePixelSize", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.CameraPixelSize": { "name": "acq_CameraPixelSize", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.CytoSettings.ChannelList.ChannelInfo.LF_HardwareChannelIndex": { "name": "object_LF_HardwareChannelIndex", "type": "[f]" },
    "instrument.measurementSettings.CytoSettings.SmartTriggerSettingDescription": { "name": "acq_SmartTriggerSettingDescription", "type": "[t]" },
    "instrument.measurementSettings.CytoSettings.SmartTriggeringEnabled": { "name": "acq_SmartTriggeringEnabled", "type": "[t]", "transform": lambda v: "true" if v else "false" },
    "instrument.measurementResults.maximum_measurement_time_s": { "name": "object_maximum_measurement_time_s", "type": "[f]" },
    "instrument.measurementResults.particleCount": { "name": "object_particleCount", "type": "[f]" },
    "instrument.measurementResults.particlesInFileCount": { "name": "object_particlesInFileCount", "type": "[f]" },
    "instrument.measurementResults.pictureCount": { "name": "object_pictureCount", "type": "[f]" },
    "instrument.measurementResults.pumped_volume": { "name": "object_pumped_volume", "type": "[f]" },
    "instrument.measurementResults.analysed_volume": { "name": "object_analysed_volume", "type": "[f]", "transform": None },
    "instrument.measurementResults.particleConcentration": { "name": "object_particleConcentration", "type": "[t]" },
    # "particles.particleId": { "name": "object_id", "type": "[t]" },
    # "particles.hasImage": { "name": "object_hasImage", "type": "[t]", "transform": lambda v: "true" if v else "false" },
